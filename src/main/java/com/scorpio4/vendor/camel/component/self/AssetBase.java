...
public class AssetBase extends Base {
	static protected final Logger log = LoggerFactory.getLogger(AssetBase.class);
	protected Asset asset;

	public AssetBase(ExecutionEnvironment engine, String assetURI) throws IOException {
